...
class GameEngine:
    ...
    def is_valid_location(board, col):
        return board[GameEngine.ROW_COUNT - 1][col] == 0
    ...
    def winning_move(board, piece):
        ...
        for c in range(GameEngine.COLUMN_COUNT - 3):
            for r in range(GameEngine.ROW_COUNT):
        ...
        for c in range(GameEngine.COLUMN_COUNT):
            for r in range(GameEngine.ROW_COUNT - 3):
        ...
        for c in range(GameEngine.COLUMN_COUNT - 3):
            for r in range(3, GameEngine.ROW_COUNT):
                if board[r][c] == piece and board[r - 1][c + 1] == piece and board[r - 2][c + 2] == piece and board[r - 3][
                    c + 3] == piece:
                    return True
